...
A CLI application for interacting with a Cloudflare account. Powered by [cloudflare-go](https://github.com/teamspiel/cloudflare-go).
...
```sh
go install github.com/teamspiel/cloudflare-go/cmd/flarectl@latest
```
